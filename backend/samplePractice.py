...
new_record = { "firstName": 'Shwetha',"lastName":"K","email":"shwethak421@gmail.com","user_id":str(uuid4()),"image":"image","userName":"shwetha","year":"2025"}
response = cursor.table('user').upsert(new_record).execute()
# print(response)
